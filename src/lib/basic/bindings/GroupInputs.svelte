<script lang="ts">
  /**
   * * GROUPS INPUT(INPUT DE GRUPO)
   *
   * Se você tiver várias type="radio" entradas type="checkbox" relacionadas ao mesmo valor, poderá usar bind:group junto com o value atributo. As entradas de rádio no mesmo grupo são mutuamente exclusivas; entradas de caixa de seleção no mesmo grupo formam uma matriz de valores selecionados.
  */
